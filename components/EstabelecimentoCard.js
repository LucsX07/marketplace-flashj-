...
export default function EstabelecimentoCard({ estabelecimento }) {
  return (
    <Link
      ...
      className={`${CARTAO_INTERATIVO} group animate-entrada block overflow-hidden`}
    >
      ...
      <div className="p-4">
        ...
        {estabelecimento.descricao && (
          <p className="mt-0.5 line-clamp-2 text-sm text-ink-muted">{estabelecimento.descricao}</p>
        )}
