...
export async function cadastrar(estadoAnterior, formData) {
  ...
  if (error) {
    ...
    return {
      erro: mensagemDeAuth(error, "Não foi possível criar a conta agora. Tente de novo em alguns minutos."),
    };
  }
...
export async function pedirRedefinicaoDeSenha(estadoAnterior, formData) {
  ...
  if (error) {
    ...
    return {
      erro: mensagemDeAuth(error, "Não foi possível enviar o e-mail agora. Tente de novo em alguns minutos."),
    };
  }
...
export async function redefinirSenha(estadoAnterior, formData) {
  ...
  if (error) {
    ...
    return {
      erro: mensagemDeAuth(error, "Não foi possível trocar a senha agora. Tente de novo em alguns minutos."),
    };
  }
